   ...
   render() {
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8" style={{textAlign:'right',direction :'rtl'}}>
        ...
        <div className="row" style={{marginBottom:"12px"}}>
            <div className="col-sm-4">
                <div className="avatarname" tooltip="پروفایل">سیّد محمد مهدی نوری اردستانی
                        <div className="dropdown-content">
                            <ul>
                                <a href="/MyProfile">صفحه شخصی من<span className="fa fa-user"></span></a>
                                <hr />
